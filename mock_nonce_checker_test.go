...
func (_m *NonceCheckerMock) CheckNonce(ctx context.Context, nonce NonceValue) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, NonceValue) error); ok {
		r0 = rf(ctx, nonce)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *NonceCheckerMock_CheckNonce_Call) Run(run func(ctx context.Context, nonce NonceValue)) *NonceCheckerMock_CheckNonce_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(NonceValue))
	})
	return _c
}
...
func (_c *NonceCheckerMock_CheckNonce_Call) RunAndReturn(run func(context.Context, NonceValue) error) *NonceCheckerMock_CheckNonce_Call {
	_c.Call.Return(run)
	return _c
}
